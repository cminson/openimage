...
{
print "<strong>\n";
print "What would your image look like in a dream?";
DisplayLineSep1();
...
DisplayLineSep1();
print "Your image will be conceptualized by a deep neural network (a form of artifical intelligence). It will then reinterpret your image and return it's <i>true</i> nature.";
DisplayLineSep1();
print "Dreaming works best on photos and larger more complex images.";
DisplayLineSep1();
print "Dreaming takes a few minutes. So get a cup of tea and then click the button and watch the show!\n";
DisplayLineSep1();
print "WARNING: You're dealing with an alien brain and it's interpretation of reaity. So don't blame me if things get <a target=_blank href=../zs/dd.html>strange</a>\n";
DisplayLineSep1();
print "</strong>\n";
}
else
