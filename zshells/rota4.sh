...
#	./rot.sh tilt=$newang zoom=-1.5 $ifile $tmp
#	../zshells/rot.sh roll=$newang zoom=-1.5 $ifile $tmp
	/home/httpd/vhosts/ezimba/httpdocs/zshells/rot.sh roll=$newang zoom=-1.5 $ifile $tmp
