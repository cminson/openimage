#!/bin/bash
#
# Developed by Fred Weinhaus 9/21/2008 .......... revised 10/6/2014
#
# ------------------------------------------------------------------------------
# 
# Licensing:
...
#	echo "s1=$s1"
	proc1='$dir/tmp1.mpc -alpha set $filter -virtual-pixel transparent -mattecolor none +distort Perspective "$s1"'
else
	proc1=""
fi
#echo "s1=$s1"
...
#	echo "s2=$s2"
	proc2='$dir/tmp2.mpc -alpha set $filter -virtual-pixel transparent -mattecolor none +distort Perspective "$s2"'
else
	proc2=""
fi
#echo "s2=$s2"
...
#	echo "s3=$s3"
	proc3='$dir/tmp3.mpc -alpha set $filter -virtual-pixel transparent -mattecolor none +distort Perspective "$s3"'
else
	proc3=""
fi
#echo "s3=$s3"
...
#	echo "s4=$s4"
	if [ $numimg -eq 4 ]; then
		proc4='$dir/tmp1.mpc $rotate -alpha set $filter -virtual-pixel transparent -mattecolor none +distort Perspective "$s4"'
	elif [ $numimg -eq 7 ]; then
		proc4='$dir/tmp4.mpc $rotate -alpha set $filter -virtual-pixel transparent -mattecolor none +distort Perspective "$s4"'
	fi
else
	proc4=""
fi
...
#	echo "s5=$s5"
	if [ $numimg -eq 4 ]; then
		proc5='$dir/tmp2.mpc $rotate -alpha set $filter -virtual-pixel transparent -mattecolor none +distort Perspective "$s5"'
	elif [ $numimg -eq 7 ]; then
		proc5='$dir/tmp5.mpc $rotate -alpha set $filter -virtual-pixel transparent -mattecolor none +distort Perspective "$s5"'
	fi
else
	proc5=""
fi
...
#	echo "s6=$s6"
	if [ $numimg -eq 4 ]; then
		proc6='$dir/tmp3.mpc $rotate -alpha set $filter -virtual-pixel transparent -mattecolor none +distort Perspective "$s6"'
	elif [ $numimg -eq 7 ]; then
		proc6='$dir/tmp6.mpc $rotate -alpha set $filter -virtual-pixel transparent -mattecolor none +distort Perspective "$s6"'
	fi
else
	proc6=""
fi
