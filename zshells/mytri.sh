#!/bin/bash
#
# Developed by Fred Weinhaus 2/26/2009 .......... revised 2/26/2009
#
# USAGE: tricolorize [-l lcolor] [-m mcolor] [-h hcolor] [-c contrast] [-o offset] [-f filter] infile outfile [lutfile]
# USAGE: tricolorize [-l lcolor] [-m mcolor] [-h hcolor] [-c contrast] [-o offset] [-f filter] lutfile
...
#                            cubic, quadratic, gaussian, triangle; default=triangle
#
###
#
# NAME: TRICOLORIZE 
...
# The choices are: cubic, gaussian, quadratic and triangle. The default=triangle.
# 
