...
initang=5
#tmp="/tmp/AATMP_$$.png"
tmp="/home/httpd/vhosts/ezimba/httpdocs/tmp/AATMP_$$.png"
...
#	./rot.sh tilt=30 pan=$newang zoom=-1.5 $ifile $tmp
#	./rot.sh pan=$newang zoom=-1.5 $ifile $tmp
	#../zshells/rot.sh tilt=$newang zoom=-1.5 $ifile $tmp
	/home/httpd/vhosts/ezimba/httpdocs/zshells/rot.sh tilt=$newang zoom=-1.5 $ifile $tmp
#	./rot.sh roll=$newang zoom=-1.5 $ifile $tmp
#	./rot.sh pan=$newang tilt=45 zoom=-1.5 $ifile $tmp
#	./rot.sh pan=$newang tilt=120 zoom=-1.5 $ifile $tmp
	if [ $ang -eq $initang ]
		then
